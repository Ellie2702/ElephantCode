...
<body>
    ...
    <main>
        <form method="POST" class="addUser" action="/script/php/addTest.php">
            <div class="fields">
                <label for="testName">Наименование:</label>
                <input type="text" placeholder="Наименование" name="test_name" required>
            </div>

            <div class="fields">
                <label for="disc">Выберите дисциплинц:</label>
