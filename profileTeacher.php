...
<body>
    ...
    <div class="profileConteiner">
        ...
        <div class="UserPanel">
            ...
            <form method="POST" class="formChange" action="/script/php/editDiscipline.php">
                Ваши специальности:
                <div class="teachDisc">
                    <?php
                        include('script/php/teacherDisciplines.php');
                    ?>
                </div>
            ...
            <form method="POST" class="formChange">
                <div class="fields">
                ...
                <div class="fields">
                    <textarea name="desc"  placeholder="Кратко опишите себя. Не более 500 символов" class="descriptField" maxlength="500"></textarea>
                </div>
            ...
            <form method="POST" class="formChange" action="/script/php/loadTeacherPhoto.php">
